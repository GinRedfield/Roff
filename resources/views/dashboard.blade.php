                    ...
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
                        ...
                        <li class="mr-1" role="presentation">
                            <button
                                ...
                                aria-controls="profile" aria-selected="true">Intro</button>
                        </li>
                        ...
                        <li class="mx-1" role="presentation">
                            <button
                                ...
                                aria-controls="dashboard" aria-selected="false">Top Performer</button>
                        </li>
                    </ul>
                </div>
                <div id="myTabContent">
                    ...
                    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard" role="tabpanel"
                        ...
                        <ul class="text-sm text-gray-500 dark:text-gray-400">
                            @foreach($stocks['returns'] as $key => $data) 
                            <li>
                                {{ strtoupper($key) }} : {{ $data }}
                            </li>
                            @endforeach
