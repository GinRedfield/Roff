        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    @isset($stocks)
                    Your portfolio avg return (Ignoring allocation): {{ number_format( ($stocks['average']*100), 2) }}%
                    @else
                    You have no active portfolio.
                    @endisset
                </div>
                ...
                <div id="myTabContent">
                    <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="intro" role="tabpanel"
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Welcome to ROFF.<br>
                            A Easy to Use Platform for Machine Learning Stock Predictions.<br>
                            Join Our Community Message Board to Participate in the Latest Market-related discussion.
